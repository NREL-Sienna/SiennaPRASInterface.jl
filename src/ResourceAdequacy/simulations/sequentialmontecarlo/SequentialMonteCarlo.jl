...
function assess(
    ...
    for s in sampleseeds
        ...
        for t in 1:N
            ...
            foreach(
                recorder -> record!(recorder, system, systemstate, dispatchproblem, s, t),
                recorders,
            )
        end
...
function initialize!(rng::AbstractRNG, state::SystemState, system::SystemModel{N}) where {N}
    ...
    initialize_availability!(
        rng,
        state.stors_available,
        state.stors_nexttransition,
        system.storages,
        N,
    )
    ...
    initialize_availability!(
        rng,
        state.genstors_available,
        state.genstors_nexttransition,
    ...
    initialize_availability!(
        rng,
        state.lines_available,
        state.lines_nexttransition,
        system.lines,
        N,
    )
