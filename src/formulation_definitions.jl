...
If not supplied, then interfaces are generated by Lines
"""
...
Each line must have a corresponding AreaInterchange, otherwise there
will be a single. AreaInterchanges will be consolidated into a
single PRAS Interface per region pair.
"""
